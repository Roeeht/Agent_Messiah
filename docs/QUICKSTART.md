...
```json
{
  "agent_reply": "Hi Roy! I'm the agent from Habari's Sales Company. We help companies increase sales with AI agents. Is this a good time to talk? Please answer ONLY yes or no.",
  "action": null,
  "action_payload": null
}
```
